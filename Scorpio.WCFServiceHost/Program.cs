...
namespace Scorpio.WCFServiceHost
{
    class Program
    {
    ...
    public class MyHelloHost : IDisposable
    {
        ...
        public static readonly Type ServiceType = typeof(WCFService.HelloService);  //服务契约实现类型  
        public static readonly Type ContractType = typeof(WCFService.IHelloService);  //服务契约接口  
